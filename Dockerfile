FROM microsoft/iis
LABEL Description="Internet Information Services (IIS) with Node.js and iisnode" Vendor="Compulim" Version="8.0.0"
...
ADD https://nodejs.org/dist/v8.0.0/node-v8.0.0-x64.msi /build/node-x64.msi
