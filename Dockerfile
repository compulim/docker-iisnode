FROM microsoft/iis
LABEL Description="Internet Information Services (IIS) with Node.js and iisnode" Vendor="Compulim" Version="7.10.0"
...
ADD https://nodejs.org/dist/v7.10.0/node-v7.10.0-x64.msi /build/node-x64.msi
